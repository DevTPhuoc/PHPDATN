          ...
          <div class="container px-6 mx-auto grid">
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-2">
              ...
              <div class="p-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div class="flex items-center mb-2">
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-400">Số Điện Thoại: {{ $donHang->phone }}</p>
                </div>
                ...
                <div class="flex items-center mb-2">
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-400">Địa Chỉ Nhận Hàng: {{ $donHang->shippingAddress}}</p>
                </div>   
            ...
            <div class="p-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
              <div class="flex items-center mb-2">
                  ...
                  <p class="text-lg font-semibold text-gray-700 dark:text-gray-200"> Mã Đơn Hàng: {{ $donHang->order_id }}</p>
              </div>             
              ...
              <div class="flex items-center mb-2">
                ...
                <p class="text-lg text-gray-600 dark:text-gray-400">Tổng Tiền: {{ $donHang->totalPrice }} VND</p>
            </div> 
            ...
            <div class="flex items-center mb-2">
              ...
              <p class="text-lg text-gray-600 dark:text-gray-400">Tình trạng thanh toán:  {{ $donHang->pay == 1 ? 'Đã thanh toán' : 'Chưa thanh toán' }}</p>
          </div>
          ...
          <div style="display: flex; align-items: center; justify-content: space-between;margin-bottom: 50px;">
            ...
            <div style="margin-top: 50px;">
              ...
              <button type="button" class="confirm-delivery-button">
                <a href="{{ route('order.confirm-delivery', ['id' => $donHang->id]) }}" class="nav-link active">Xác nhận giao hàng</a>
              </button> ||
              ...
              @endif
              @if ($donHang->role != -1)
              <button type="button" class="delete-button"><a href="{{ route('order.cancel', ['id' => $donHang->id]) }}" class="nav-link active">Hủy đơn</a></button>
              @endif
            </div>
