...
<main class="h-full overflow-y-auto">
              ...
              <!-- Card infor -->
                <div class="p-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <div class="flex items-center mb-2">
                        ...
                        <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">{{ $categories->name}}</p>
                    </div>
                </div>  
              
            </div>
            <div class="update-product">
              <button class="update-button" > <a href="{{ route('categories.update',['id'=>$categories->id]) }}"> Cập nhật thông tin </a> </button>
            </div>
            <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  ...
                  <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    @foreach($dsProducts as $Products)
                    <tr class="text-center text-gray-700 dark:text-gray-400" onclick="window.location.href = '{{ route('product.detail',['id'=>$Products->id]) }}';">
                      ...
                      <td class="px-4 py-3 text-xs"> 
                        ...
                        @elseif($Products->promotions_id== 2)
                        {{-- Hết hàng --}}
                            <span class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:bg-red-700 dark:text-red-100">
                              Sold
                            </span>
                        @elseif($Products->promotions_id == 0)
                        {{-- Ngừng sản xuất --}}
                            <span class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:bg-red-700 dark:text-red-100">
                              Discontinued
                            </span>
          ...
          <form action="">
            ...
            Delete
                ...
                <div class="mt-4">
                  {{ $dsProducts->links() }} <!-- Hiển thị thanh phân trang -->
                </div> 
                <tbody>
