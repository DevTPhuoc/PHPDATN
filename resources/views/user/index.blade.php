    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
      <div class="w-full overflow-x-auto">
        ...
        <tr class="text-gray-700 dark:text-gray-400"
          ...
          <td class="px-4 py-3 text-xs">
          <span class="text-md  px-2 py-1 font-semibold{{ $user->role == 1 ? 'leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100' : 'leading-tight text-red-700 bg-red-100 rounded-full dark:bg-red-700 dark:text-red-100' }}">
