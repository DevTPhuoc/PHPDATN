            ...
            <div class="flex justify-center flex-1 lg:mr-32 mb-10">
                <div class="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
                    ...
                    <input
                        ...
                        type="text" placeholder="Tìm kiếm theo tên sản phẩm " aria-label="Search" name="keyword">
                </div>
                <button type="submit"
        ...
        <table class="w-full whitespace-no-wrap">
            <thead>
                <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                    ...
                    <th class="px-5 py-3">Ảnh Sản Phẩm</th>
            ...
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                ...
                <tr class="text-gray-700 dark:text-gray-400"
                    ...
                    <td class="px-4 py-3 text-sm">
                        ...
                        <img src="{{ asset('img/add/' . $product->images->first()->name) }}"
