              ...
              <!-- Card infor -->
                <div class="p-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    ...
                    <div class="flex items-center mb-2">
                        ...
                        <p class="text-lg text-gray-600 dark:text-gray-400">Giá bán:</p>
                    </div>
                    ...
                    <div class="flex items-center mb-2">
                        ...
                        <p class="text-lg text-gray-600 dark:text-gray-400">Giá nhập: </p>
                    </div>
                    ...
                    <div class="flex items-center mb-2">
                        ...
                        <p class="text-lg text-gray-600 dark:text-gray-400"> Nhà cung cấp: </p>
                    </div>
                    ...
                    <div class="flex items-center mb-2">
                      ...
                      <p class="text-lg text-gray-600 dark:text-gray-400"> Loại sản phẩm: </p>
                    </div>
