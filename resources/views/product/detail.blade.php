...
<main class="h-full overflow-y-auto">
          <div class="container px-6 mx-auto grid">
              ...
              <!-- Card infor -->
                <div class="p-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    ...
                    <div class="flex items-center mb-2">
                        ...
                        <p class="text-lg text-gray-600 dark:text-gray-400">Giá Bán: {{ $Products->selling_price }}</p>
                    </div>
            ...
            <div class="update-product">
              <button class="update-button" > <a href="{{ route('product.update',['id'=>$Products->id]) }}"> Cập nhật thông tin </a> </button>
            </div>
            <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
             ...
             <div class="w-full overflow-hidden rounded-lg shadow-xs mt-10">
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap item-center">
                  ...
                  @foreach($dsChiTietSP as $Products)
                ...
                <table class="w-full whitespace-no-wrap item-center">
                  ...
                  <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    <tr class="text-center text-gray-700 dark:text-gray-400" >
                      ...
                      <td class="px-4 py-3">                                                
                          <img src="" alt="Hình ảnh" style="width: 100px;
                          height: 100px;
                          object-fit: cover;">
                      </td>
                      <td class="px-4 py-3"> 
