    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-2">
      ...
      <div class="p-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <div class="flex items-center mb-2">
          <svg class="w-12 h-8 mr-2 text-gray-600 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <g id="business-card--name-card-business-information-money-payment">
              <path id="Vector" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M16.580357142857142 3.316071428571429h-14.590714285714286c-0.7325666035714287 0 -1.3264285714285715 0.5938686000000001 -1.3264285714285715 1.3264285714285715v9.285c0 0.7325865 0.5938619678571428 1.3264285714285715 1.3264285714285715 1.3264285714285715h14.590714285714286c0.7325865 0 1.3264285714285715 -0.5938420714285715 1.3264285714285715 -1.3264285714285715v-9.285c0 -0.7325599714285714 -0.5938420714285715 -1.3264285714285715 -1.3264285714285715 -1.3264285714285715Z"
                stroke-width="1.43"></path>
              <path id="Vector_2" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M5.968928571428572 11.274642857142858C7.067781792857144 11.274642857142858 7.958571428571429 10.383853221428572 7.958571428571429 9.285s-0.8907896357142858 -1.9896428571428573 -1.9896428571428573 -1.9896428571428573S3.9792857142857145 8.186146778571429 3.9792857142857145 9.285s0.8907896357142858 1.9896428571428573 1.9896428571428573 1.9896428571428573Z"
                stroke-width="1.43"></path>
              <path id="Vector_3" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M11.274642857142858 7.295357142857143H14.590714285714286" stroke-width="1.43"></path>
              <path id="Vector_4" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M11.274642857142858 11.274642857142858H14.590714285714286" stroke-width="1.43"></path>
            </g>
          </svg>
        ...
        <!-- <div class="flex items-center mb-2">
                        ...
                        <p class="text-lg text-gray-600 dark:text-gray-400">Giá Nhập: {{ $product ->price }}</p>
                    </div> -->
        ...
        <div class="flex items-center mb-2">
          ...
          <svg class="w-12 h-8 mr-2 text-gray-600 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <g id="payment-cash-out-3">
              <path id="Vector 2494" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M9.285 15.253928571428572v2.652857142857143" stroke-width="1.43"></path>
              <path id="Vector 2495" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M12.60107142857143 13.9275v2.652857142857143" stroke-width="1.43"></path>
              <path id="Vector 2496" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M5.968928571428572 13.9275v2.652857142857143" stroke-width="1.43"></path>
              <path id="Vector" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M16.580357142857142 0.6632142857142858h-14.590714285714286c-0.7325666035714287 0 -1.3264285714285715 0.5938619678571428 -1.3264285714285715 1.3264285714285715v7.958571428571429c0 0.7325599714285714 0.5938619678571428 1.3264285714285715 1.3264285714285715 1.3264285714285715h14.590714285714286c0.7325865 0 1.3264285714285715 -0.5938686000000001 1.3264285714285715 -1.3264285714285715v-7.958571428571429c0 -0.7325666035714287 -0.5938420714285715 -1.3264285714285715 -1.3264285714285715 -1.3264285714285715Z"
                stroke-width="1.43"></path>
              <path id="Vector_2" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M9.285 8.290178571428571c1.2819932142857144 0 2.32125 -1.0392567857142858 2.32125 -2.32125S10.566993214285715 3.6476785714285715 9.285 3.6476785714285715s-2.32125 1.0392567857142858 -2.32125 2.32125S8.003006785714286 8.290178571428571 9.285 8.290178571428571Z"
                stroke-width="1.43"></path>
              <g id="Group 8">
                <path id="Ellipse 1" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                  d="M3.6807066428571433 6.300535714285715c-0.18313999285714286 0 -0.3316071428571429 -0.14846715000000002 -0.3316071428571429 -0.3316071428571429s0.14846715000000002 -0.3316071428571429 0.3316071428571429 -0.3316071428571429"
                  stroke-width="1.43"></path>
                <path id="Ellipse 2" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                  d="M3.6807066428571433 6.300535714285715c0.18313999285714286 0 0.3316071428571429 -0.14846715000000002 0.3316071428571429 -0.3316071428571429s-0.14846715000000002 -0.3316071428571429 -0.3316071428571429 -0.3316071428571429"
                  stroke-width="1.43"></path>
              </g>
              <g id="Group 9">
                <path id="Ellipse 1_2" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                  d="M14.889293357142858 6.300535714285715c-0.18317978571428573 0 -0.3316071428571429 -0.14846715000000002 -0.3316071428571429 -0.3316071428571429s0.14842735714285715 -0.3316071428571429 0.3316071428571429 -0.3316071428571429"
                  stroke-width="1.43"></path>
                <path id="Ellipse 2_2" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                  d="M14.889293357142858 6.300535714285715c0.18317978571428573 0 0.3316071428571429 -0.14846715000000002 0.3316071428571429 -0.3316071428571429s-0.14842735714285715 -0.3316071428571429 -0.3316071428571429 -0.3316071428571429"
                  stroke-width="1.43"></path>
              </g>
            </g>
          </svg>

          <p class="text-lg text-gray-600 dark:text-gray-400">Giá Bán: {{ number_format($product->selling_price, 0, ',', '.') }} VND</>
          </p>
        </div>
        ...
        <div class="flex items-center mb-2">
          ...
          <svg class="w-12 h-8 mr-2 text-gray-600 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <g id="factory-plant--business-factory-plant">
              <path id="Vector 1689" stroke="#000" stroke-linecap="round" stroke-linejoin="round" d="M37 33H27"
                stroke-width="3"></path>
              <path id="Vector 1690" stroke="#000" stroke-linecap="round" stroke-linejoin="round" d="M37 38H27"
                stroke-width="3"></path>
              <path id="Vector 1691" stroke="#000" stroke-linecap="round" stroke-linejoin="round" d="M39.5 14h-11"
                stroke-width="3"></path>
              <path id="Vector" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M23 4c-2.761 -1.253 -6.154 -1.411 -10 0S5.761 5.253 3 4" stroke-width="3"></path>
              <path id="Vector_2" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M23 10c-2.761 -1.253 -6.154 -1.411 -10 0s-7.239 1.253 -10 0" stroke-width="3"></path>
              <path id="Union" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M3 27.912c0 -1.985 0.737 -3.904 2.283 -5.148 2.23 -1.795 6.107 -4.436 11.698 -6.577 1.804 -0.692 3.688 0.621 3.77 2.551 0.08 1.914 0.168 4.425 0.214 7.22l21.037 0a2.998 2.998 0 0 1 2.998 3l0 6.5c0 2.526 -0.159 4.475 -0.35 5.907 -0.26 1.94 -1.9 3.228 -3.856 3.309 -3.109 0.129 -8.572 0.285 -16.794 0.285 -8.222 0 -13.685 -0.156 -16.794 -0.285 -1.956 -0.081 -3.597 -1.368 -3.856 -3.309C3.16 39.933 3 37.984 3 35.46l0 -7.548Z"
                stroke-width="3"></path>
              <path id="Intersect" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M18.962 44.98c0.022 -1.012 0.038 -2.315 0.038 -3.98 0 -2.4 -0.033 -4.05 -0.071 -5.157 -0.046 -1.327 -0.72 -2.51 -2.033 -2.713A12.452 12.452 0 0 0 15 33c-0.768 0 -1.392 0.052 -1.896 0.13 -1.313 0.203 -1.987 1.386 -2.033 2.713A151.965 151.965 0 0 0 11 41c0 1.592 0.014 2.853 0.035 3.845"
                stroke-width="3"></path>
              <path id="Rectangle 1675" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M27 26a643.11 643.11 0 0 1 1.843 -17.429c0.151 -1.258 1.085 -2.274 2.345 -2.413A25.93 25.93 0 0 1 34 6c1.05 0 2.018 0.071 2.812 0.158 1.26 0.14 2.194 1.155 2.345 2.413A643.11 643.11 0 0 1 41 26"
                stroke-width="3"></path>
            </g>
          </svg>

          <p class="text-lg text-gray-600 dark:text-gray-400"> Nhà cung cấp: {{  $product->suppliers->name }}
          </p>
        </div>
        ...
        <div class="flex items-center mb-2">
          <svg class="w-12 h-8 mr-2 text-gray-600 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <g id="tag--tags-bookmark-favorite">
              <path id="Intersect" stroke="#000000" stroke-linecap="round" stroke-linejoin="round"
                d="M7.291 12.697c0.708 0.647 1.789 0.69 2.562 0.122 0.557 -0.409 1.116 -0.841 1.621 -1.347 0.505 -0.505 0.938 -1.064 1.347 -1.621 0.567 -0.773 0.525 -1.853 -0.122 -2.562a76.962 76.962 0 0 0 -5.798 -5.712 1.853 1.853 0 0 0 -0.876 -0.439C4.84 0.908 1.882 0.422 1.153 1.151 0.424 1.88 0.91 4.838 1.14 6.023c0.064 0.327 0.217 0.627 0.438 0.876a76.962 76.962 0 0 0 5.713 5.798Z"
                stroke-width="1"></path>
              <path id="Vector" stroke="#000000" stroke-linecap="round" stroke-linejoin="round"
                d="M4.662 5.81c0.736 0 1.15 -0.414 1.15 -1.15 0 -0.737 -0.414 -1.151 -1.15 -1.151 -0.737 0 -1.15 0.414 -1.15 1.15 0 0.737 0.413 1.151 1.15 1.151Z"
                stroke-width="1"></path>
            </g>
          </svg>
          <p class="text-lg text-gray-600 dark:text-gray-400"> Loại sản phẩm: {{$product->categories->name}}</p>
        </div>
      ...
      <div class="p-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <div class="flex items-center mb-2">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="-0.5 -0.5 14 14"
            class="w-12 h-8 mr-2 text-gray-600 dark:text-gray-400">
            <g id="bag--bag-payment-cash-money-finance">
              <path id="Vector" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M6.5 12.535807142857143c3.25 0 5.571428571428571 -1.1514285714285715 5.571428571428571 -3.7142485714285716 0 -2.7857142857142856 -1.3928571428571428 -4.197245 -4.178571428571429 -5.590102142857143l1.2049328571428572 -1.882882857142857c0.04730142857142857 -0.09084214285714286 0.07071071428571428 -0.19223285714285715 0.06802714285714287 -0.29461714285714286 -0.0026928571428571427 -0.10239357142857144 -0.031395 -0.2024109285714286 -0.08341357142857142 -0.29064564285714284 -0.052009285714285716 -0.08823564285714286 -0.12561714285714287 -0.16178314285714285 -0.21389642857142857 -0.21372000000000002 -0.08827928571428571 -0.05193592857142858 -0.18832357142857142 -0.08055264285714286 -0.2907171428571429 -0.08315542857142857h-3.9371428571428573C4.531428571428571 0.46435907142857147 4.4236957142857145 0.4919627142857143 4.328935 0.5463017857142857c-0.09477000000000001 0.054340000000000006 -0.17300214285714285 0.13337814285714286 -0.2263764285714286 0.22868857142857144 -0.05337428571428572 0.09531042857142857 -0.079885 0.20331535714285717 -0.0767 0.3125060714285714 0.003185 0.1091907142857143 0.035945000000000005 0.215475 0.09478857142857143 0.3075057142857143L5.107142857142858 3.2314564285714287c-2.7857142857142856 1.4114285714285715 -4.178571428571429 2.8229592857142856 -4.178571428571429 5.608673571428572 0 2.5442485714285716 2.3214285714285716 3.6956771428571433 5.571428571428571 3.6956771428571433Z"
                stroke-width="1"></path>
              <path id="Vector 19" stroke="#000" stroke-linecap="round" stroke-linejoin="round"
                d="M5.107142857142858 3.25v0c0.66261 0.9939150000000001 2.123104285714286 0.9939150000000001 2.7857142857142856 0v0"
                stroke-width="1"></path>
            </g>
          </svg>

          <p class="text-lg text-gray-700 dark:text-gray-200">Sản phẩm còn lại: {{ $dsChiTietSP->sum('quantity_detail') }}</p>
        ...
        <table class="w-full whitespace-no-wrap item-center">
          ...
          <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
            ...
            <tr class="text-center text-gray-700 dark:text-gray-400">
              ...
              <td class="px-4 py-3">
                <button type="button" class="delete-button"><a href=""> Xóa</a></button>
              </td>
            </tr>
            @php  
        $stt++; 
