              ...
              <!-- Card infor -->
                <div class="p-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <div class="flex items-center mb-2">
                        ...
                        <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">{{ $sanPham->name }}</p>
                    </div>
                    <div class="flex items-center mb-2">
                        ...
                        <p class="text-lg text-gray-600 dark:text-gray-400">Giá bán: {{ $sanPham->price }}</p>
                    </div>
                    ...
                    <div class="flex items-center mb-2">
                        ...
                        <p class="text-lg text-gray-600 dark:text-gray-400">Giá nhập: {{ $sanPham->size }}</p>
                    </div>
                    ...
                    <div class="flex items-center mb-2">
                        ...
                        <p class="text-lg text-gray-600 dark:text-gray-400"> Nhà cung cấp: {{ $sanPham->suppliers->name }}</p>
                    </div>
                    ...
                    <div class="flex items-center mb-2">
                      ...
                      <p class="text-lg text-gray-600 dark:text-gray-400"> Loại sản phẩm: {{ $sanPham->categories->name }}</p>
                    </div>
                ...
                <div class="p-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    ...
                    <div class="flex items-center mb-2">
                      ...
                      @if( $sanPham->khuyen_mai_id == 0 )
                        ...
                        @else
                          <p class="text-lg text-gray-600 dark:text-gray-400">Khuyến mãi: {{$sanPham->categories->name}}</p>
                        @endif                          
