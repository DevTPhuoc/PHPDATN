...
<main class="h-full overflow-y-auto">
  <div class="container px-6 mx-auto grid">
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-2">
      ...
      <div class="p-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <div class="flex items-center mb-2">
          ...
          <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">{{ $Products->name }}</p>
        </div>
        <!-- <div class="flex items-center mb-2">
                        ...
                        <p class="text-lg text-gray-600 dark:text-gray-400">Giá Nhập: {{ $Products->price }}</p>
                    </div> -->
        ...
        <div class="flex items-center mb-2">
          ...
          <p class="text-lg text-gray-600 dark:text-gray-400">Giá Bán: {{ $Products->price }}</p>
        </div>
        ...
        <div class="flex items-center mb-2">
          ...
          <p class="text-lg text-gray-600 dark:text-gray-400"> Nhà cung cấp: {{  $Products->suppliers->name }}
          </p>
        </div>
        ...
        <div class="flex items-center mb-2">
          ...
          <p class="text-lg text-gray-600 dark:text-gray-400"> Loại sản phẩm: {{$Products->categories->name}}</p>
        </div>
      ...
      <div class="p-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <div class="flex items-center mb-2">
          ...
          <p class="text-lg text-gray-600 dark:text-gray-400">Khuyến mãi: {{$Products->promotion->code_promotion}}</p>
    ...
    <div class="update-product">
      <button class="update-button"> <a href="{{ route('product.update', ['id' => $Products->id]) }}"> Cập nhật thông tin
        </a> </button>
    </div>
    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
